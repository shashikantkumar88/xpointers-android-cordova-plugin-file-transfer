...
public class FileTransfer extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        if (action.equals("upload") || action.equals("download")) {
            ...
            return true;
        } else if (action.equals("megabytesAvailable")) {
            String folderName = args.getString(0);
            float totalSize = megabytesAvailable(new File(folderName));
            callbackContext.success(totalSize + "");
            return true;
        }
        return false;
    }
     ...
     *
     * args[2] fileKey Name of file request parameter args[3] fileName File name
     * to be used on server args[4] mimeType Describes file content type args[5]
     * params key:value pairs of user-defined parameters
    ...
    public float megabytesAvailable(File directory) {
